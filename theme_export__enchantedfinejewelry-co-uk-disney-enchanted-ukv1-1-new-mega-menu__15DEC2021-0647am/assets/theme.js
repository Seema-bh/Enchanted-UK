                      ...
                      <div class="pro-name-and-price">
                        ...
                        <div class="price-qty-remove">
                          ...
                          <div class="option quantity-box text-center">
                            ...
                            <img src="https://cdn.shopify.com/s/files/1/0428/7853/3793/files/Remove-Delete_Icon.svg?v=1613016434"/>
                          </a>
                      </div>
					          </div>
                </li>`;
...
//             _toggleBodyCart();
    ...
    _liveRegionText: function(variant) {
      ...
      var regularPriceNumber = variant.price/100;
      console.log(regularPriceNumber);
      $('.price__stock--info .product__price').attr('data-selling-price',regularPriceNumber);
      var saleLabel = '';
      var salePrice = '';
      var unitLabel = '';
      var unitPrice = '';
...
$(document).ready(function() {
  ...
  var footerAccordian = {
    footerAccordian: function(){
      $('.accordion_btn_foot:first').addClass( 'active_foot' );
      $('.accordion_text_foot:first').css("display","block");
      $('.accordion_btn_foot').on('click',function(){
      	$(this).toggleClass('active_foot').closest('.site-footer__item-inner').find('.accordion_text_foot').stop().slideToggle();
      });
    }
  }
...
//   ProductPage.initSizeChart();
  ...
  footerAccordian.footerAccordian();
...
//     console.log(1);
    if ($('#mhaRnProduct').children().length > 0 ) {
      console.log(1);
      myStopFunction();
      var htmlCode = `<img src="https://cdn.shopify.com/s/files/1/0428/7853/3793/files/Bag_Button_Icon_-_Big.png?v=1616650902">
              <span data-add-to-cart-text="">Join the wishlist</span>`
  ...
  var variantPrice = $('.price__stock--info .product__price').attr('data-selling-price');
  var variantNyRings = $('.price__stock--info').attr('data-nyrings');
  console.log(variantNyRings);
  if(variantNyRings != undefined){
    $(".product-form__input").on("change",function(){
      var onChagneSize = $(this).find("option:selected").val();
      var onChagnePrice = $('.price__stock--info .product__price').attr('data-selling-price');
  ...
  var GDPRCookies = Cookies.get('gdprCookies');
  console.log("GDPRCookies",GDPRCookies);
  if( GDPRCookies != "accepted" ){
  	$(".europe-gdpr").show();
    Cookies.set('gdprCookies',"undefined");
  }
  $(".europe-gdpr .btn").on("click",function(e){
    $(".europe-gdpr").hide();
    e.preventDefault();
    Cookies.set('gdprCookies',"accepted");
  })
  ...
  function ValidateRegisterForm() {
    ...
    $('.register__account input').removeClass('input--error');
    $('.register__account [data-form-error]').html('').hide();
  ...
  $('.register__account .btn').on('click', function(e) {
